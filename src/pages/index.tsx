...
export default function Home({ trending, topRated, tvTopRated, popular, documentary, comedy, family, history, products }: HomeProps): JSX.Element {
  ...
  return (
    <div className={`relative min-h-screen ${modal && "!h-screen overflow-hidden"}`}>
      <Head>
        <title>Diyorbek Movies | Home</title>
